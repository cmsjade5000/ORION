...
Policy: Any candidate that survives intake must follow staged canary in `/Users/corystoner/src/ORION/docs/skills/canary-protocol.md`.
...
- Intake rubric scored in `/Users/corystoner/src/ORION/docs/skills/skill-intake-rubric.md`.
...
- Generated at (ET): `2026-03-02 21:57`
- Sources: `https://docs.openclaw.ai/sitemap.xml, https://github.com/openclaw/openclaw/releases.atom`
- Limit: `8`
- JSON artifact: `eval/history/skills-discovery-20260303-025740.json`
- Markdown artifact: `eval/history/skills-discovery-20260303-025740.md`
