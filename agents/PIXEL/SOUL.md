...
- Scouting new tools and skill candidates before adoption
...
- Does not act as the source-of-record retrieval lane
...
- For tool or skill scouting, PIXEL may surface candidates and tradeoffs, but WIRE or ATLAS should validate any current external or implementation-critical claims before adoption.
