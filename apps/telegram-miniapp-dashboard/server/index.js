...
const PRIMARY_AGENTS = ["ATLAS", "POLARIS", "EMBER", "PIXEL", "QUEST", "LEDGER", "AEGIS"];
...
function simulatePdfArtifact({ text, agentId }) {
  ...
  const bytes = renderSimplePdfBytes({ title: req.title, body: "Generated by ORION Mini App preview." });
...
function buildDocxBytes() {
  ...
  return zipStore([
    ...
    },
    {
      ...
      data: xml(`<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<w:document xmlns:w=\"http://schemas.openxmlformats.org/wordprocessingml/2006/main\">\n  <w:body>\n    <w:p><w:r><w:t>ORION Miniapp DOCX</w:t></w:r></w:p>\n    <w:p><w:r><w:t>Generated by ORION Mini App preview.</w:t></w:r></w:p>\n    <w:sectPr/>\n  </w:body>\n</w:document>`),
    },
  ]);
}
...
function simulateArtifactsFromText({ text, agentId }) {
  ...
  if (/\b(zip|archive)\b/i.test(raw)) {
    const rec = simulateArtifactBytes({
      ...
      bytes: zipStore([
        { name: "readme.txt", data: Buffer.from("ORION zip preview\n", "utf8") },
